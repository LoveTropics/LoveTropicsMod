...
public final class GameMap {
	...
	private final Consumer<IGameInstance> close;

	private GameMap(@Nullable String name, RegistryKey<World> dimension, MapRegions mapRegions, @Nullable Consumer<IGameInstance> close) {
		this.name = name;
	...
	public GameMap onClose(Consumer<IGameInstance> close) {
		return new GameMap(name, dimension, mapRegions, close);
	}

	public void close(IGameInstance minigame) {
		if (this.close != null) {
