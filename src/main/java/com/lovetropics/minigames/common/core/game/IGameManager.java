 ...
 */
public interface IGameManager extends GameControllable
{
    /**
     * Get all currently registered minigames.
     * @return A collection of all known minigames.
     */
    Collection<IGameDefinition> getAllMinigames();
     ...
     */
    IGameInstance getActiveMinigame();

    /**
     * Finishes the actively running minigame, teleporting players back to
     * their original state before joining the minigame.
     */
    GameResult<ITextComponent> finish();

    /**
     * Cancels the actively running minigame. Inherents all logic of {@link IGameManager#finish()}
     */
    GameResult<ITextComponent> cancel();
     ...
     */
    GameResult<ITextComponent> startPolling(ResourceLocation minigameId, PlayerKey initiator);

    /**
     * Stops polling an actively polling minigame.
     * @return The result of stopping the polling of an actively polling minigame.
     */
    GameResult<ITextComponent> stopPolling();
     ...
     */
    CompletableFuture<GameResult<ITextComponent>> start();
