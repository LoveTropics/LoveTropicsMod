...
public class MinigameEntities {
	...
	public static final RegistryEntry<EntityType<QuietLightningBolt>> QUIET_LIGHTNING_BOLT = REGISTRATE.entity("quiet_lightning_bolt", QuietLightningBolt::new, MobCategory.MISC)
