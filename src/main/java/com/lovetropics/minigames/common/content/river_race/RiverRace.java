...
public class RiverRace {
    ...
    public static final GameBehaviorEntry<RiverRaceZonesBehavior> ZONES_BEHAVIOR = REGISTRATE.object("river_race/zones").behavior(RiverRaceZonesBehavior.CODEC).register();
