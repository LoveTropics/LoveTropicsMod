...
public class BeachFloatModel extends EntityModel<BeachFloatEntity> {

    public RendererModel floatCross4;
    public RendererModel floatCross3;
    public RendererModel floatCross2;
    public RendererModel floatCross1;
    public RendererModel topFloatCross4;
    public RendererModel topFloatCross3;
    public RendererModel topFloatCross2;
    public RendererModel topFloatCross1;
    public RendererModel floatFoot;
    public RendererModel floatTop;
    public RendererModel headPillow;
    public RendererModel topBed;
    public RendererModel bottomBed;

    public BeachFloatModel() {
        floatCross4 = new RendererModel(this, 0, 0);
        ...
        floatCross3 = new RendererModel(this, 0, 0);
        ...
        floatCross2 = new RendererModel(this, 0, 0);
        ...
        floatCross1 = new RendererModel(this, 0, 0);
        ...
        topFloatCross4 = new RendererModel(this, 0, 0);
        ...
        topFloatCross3 = new RendererModel(this, 0, 0);
        ...
        topFloatCross2 = new RendererModel(this, 0, 0);
        ...
        topFloatCross1 = new RendererModel(this, 0, 0);
        ...
        floatFoot = new RendererModel(this, 0, 4);
        ...
        floatTop = new RendererModel(this, 0, 4);
        ...
        headPillow = new RendererModel(this, 0, 13);
        ...
        topBed = new RendererModel(this, 0, 19);
        ...
        bottomBed = new RendererModel(this, 0, 19);
    ...
    @Override
    public void render(BeachFloatEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
