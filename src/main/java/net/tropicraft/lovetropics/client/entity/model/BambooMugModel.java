...
public class BambooMugModel extends Model {
    ...
    public RendererModel wall1;
    public RendererModel wall2;
    public RendererModel wall3;
    public RendererModel wall4;
    public RendererModel liquid;
    public RendererModel handletop;
    public RendererModel handlebottom;
    ...
    public BambooMugModel() {
        ...
        handlebottom = new RendererModel(this, 26, 2);
        ...
        handle = new RendererModel(this, 32, 0);
