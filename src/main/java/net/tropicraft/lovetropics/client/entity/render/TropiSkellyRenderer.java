...
import net.tropicraft.lovetropics.client.entity.model.TropiSkellyModel;
import net.tropicraft.lovetropics.client.entity.render.layer.TropiSkellyHeldItemLayer;
