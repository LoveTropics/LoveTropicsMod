...
public class SeahorseModel extends EntityModel<SeahorseEntity> {
   ...
   @Override
   public void render(SeahorseEntity seahorse, float par2, float par3, float par4, float par5, float par6, float par7) {
        ...
        setRotationAngles(seahorse, par2, par3, par4, par5, par6, par7);
    ...
    */
   @Override
   public void setRotationAngles(SeahorseEntity entity, float par1, float par2, float par3, float par4, float par5, float par6) {
